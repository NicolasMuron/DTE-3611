...
namespace dte3611::predef::testing::flow::fixtures
{
  ...
  using MinCostMaxFlowDAG2 = GoldGraphTestF<gold::MinCostMaxFlowDAG2>;

  //Application mincostfow
  using BloodDonationBipartiteF = GoldGraphTestF<gold::BloodDonationBipartite>;
